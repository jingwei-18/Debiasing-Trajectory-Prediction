...
model = model.SocialModel_no(args).to(device)
...
#train_loader = pickle.load(open('./sep_train_test/train.pkl','rb'))
#valid_loader = pickle.load(open('./sep_train_test/test.pkl','rb'))
...
for epoch in range(args.num_epochs):
    ...
    if np.mean(record_loss)<valid_loss_best:
        ...
        model.save('logs/model_no_Ten.pkl')

    if epoch%20==0:
        model.save(f'logs/model_no_epoch{epoch}_Ten.pkl')
model.save('logs/model_no_last_Ten.pkl')    
